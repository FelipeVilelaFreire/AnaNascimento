...
export const anaTheme = {
  ...
  tokens: {
    typography: {
      bodyFamily: "var(--font-karla), Karla, Arial, Helvetica, ui-sans-serif, system-ui, sans-serif",
      headingFamily: "var(--font-marcellus), Marcellus, Georgia, serif",
      monoFamily: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",
      fontFamilyBody: "var(--font-karla), Karla, Arial, Helvetica, ui-sans-serif, system-ui, sans-serif",
      fontFamilyHeading: "var(--font-marcellus), Marcellus, Georgia, serif",
      size2xs: 12,
      sizeXs: 14,
      sizeSm: 16,
      sizeMd: 18,
